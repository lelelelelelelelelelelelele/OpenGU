...
def test_small_selection_gu_runner_recipe_is_exact_and_collectable():
    definition = sm.runner_recipe_definition("opengu-small-selection-gu-gate-v3")
    ...
    assert definition["argv"] == [
        ...
        "--config",
        "experiments/configs/syncmate_small_selection_gu_gate_v3.yaml",
        "--json",
    ]
    ...
    assert definition["expected_artifact_paths"] == list(
        sm.SMALL_SELECTION_GU_V3_EXPECTED_ARTIFACTS
    )
...
def test_small_selection_gu_stage_recipes_are_exact_bounded_and_collectable():
    definition = sm.runner_recipe_definition(
        "opengu-small-selection-gu-citeseer-seed212-v3"
    )
    ...
    assert definition["argv"] == [
        ...
        "--config",
        "experiments/configs/syncmate_small_selection_gu_full_v3.yaml",
        "--stage",
        "citeseer-seed212",
        "--json",
    ]
