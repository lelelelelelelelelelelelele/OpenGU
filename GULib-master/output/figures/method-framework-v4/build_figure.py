...
W,H=925,355
c=canvas.Canvas(str(OUT/'method-framework-v4.pdf'),pagesize=(W,H))
c.setTitle('Graph unlearning framework')
doc=E.Element('mxfile',host='app.diagrams.net')
d=E.SubElement(doc,'diagram',name='Framework',id='framework-v4')
...
# Model-state icons: one checkpoint, or multiple shard models plus aggregation.
box(539,29,32,21,'#EAF1F8','#8CAAC3')
text(542,30,26,'M',13,True)
text(516,60,78,'Checkpoint',10)
for xx in [622,647,672]:
 box(xx,29,17,15,'#D8ECEB','#85B5B4')
line([(630,44),(630,50),(655,50)],T,False)
line([(680,44),(680,50),(655,50)],T,False)
line([(655,44),(655,54)],T,False)
box(644,54,22,5,'#A6C8D6','#85AABA')
text(608,62,95,'Shards + agg.',10)
...
E.ElementTree(doc).write(OUT/'method-framework-v4.drawio',encoding='utf-8',xml_declaration=True)
pdf=pdfium.PdfDocument(str(OUT/'method-framework-v4.pdf'))
pdf[0].render(scale=2).to_pil().save(OUT/'method-framework-v4.png')
assert len(pdf)==1
...
print('Created v4. Access and trained-model connections verified.')
