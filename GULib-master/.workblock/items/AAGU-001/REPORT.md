...
- 待决定候选为本报告所在 source branch `refs/heads/codex/aagu-001-experiment-contract` 的干净 HEAD；报告完成后的最终复验另存[最终回执](../../runtime/evidence/AAGU-001/verify-final.json)，由相同脚本复验当前候选。
