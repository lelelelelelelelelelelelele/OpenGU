...
| GUIDE (免疫) | ✅ -0.0458 | ✅ -0.0834 | ✅ -0.0521 | ✅ -0.0517 | ✅ -0.0517 | ✅ -0.0517 |
...
#### GUIDE (Shard-based, 免疫 - 对照组)

| Strategy | F1 Drop | Gap% | MeanShift | Flipped% |
|----------|---------|------|-----------|----------|
| degree | **-0.0834** | TBD | TBD | TBD |
| pagerank | -0.0521 | TBD | TBD | TBD |
| random | -0.0458 | TBD | TBD | TBD |
| tracin | -0.0517 | TBD | TBD | TBD |
| im | -0.0517 | TBD | TBD | TBD |
| hybrid | -0.0517 | TBD | TBD | TBD |

> **关键发现**: GUIDE 在所有6个攻击策略下 F1 Drop 均为负值（-0.0458 ~ -0.0834），**完全免疫定向攻击**。与 GraphEraser 对比，两者均为 Shard-based，但 GUIDE 的免疫性更稳定（负值范围更窄），验证了子图修复（MixUp）策略的鲁棒性。
