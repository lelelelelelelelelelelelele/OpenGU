...
class AttackResult:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "f1_before": float(self.f1_before) if self.f1_before is not None else None,
            "f1_after": float(self.f1_after),
            "f1_drop": float(self.f1_drop) if self.f1_drop is not None else None,
            "f1_drop_ratio": float(self.f1_drop_ratio) if self.f1_drop_ratio is not None else None,
            "unlearn_time": float(self.unlearn_time),
            "total_time": float(self.total_time),
            "selection_time": float(self.selection_time) if self.selection_time is not None else None,
            "selection_reuse_time": float(self.selection_reuse_time) if self.selection_reuse_time is not None else None,
            ...
            "mia_auc": float(self.mia_auc) if self.mia_auc is not None else None,
