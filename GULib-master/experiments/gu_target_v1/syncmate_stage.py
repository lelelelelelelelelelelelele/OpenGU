...
CONFIG_PATH = (
    REPO_ROOT / "experiments" / "configs" / "syncmate_small_selection_gu_full_v1.yaml"
)
EVIDENCE_ROOT = Path("/autodl-fs/data/OpenGU-small-selection-gu/20260722/full-v1")
RUN_ROOT = REPO_ROOT / "results" / "runs" / "__syncmate_small_selection_gu_full_v1__"
...
def _config() -> Dict[str, Any]:
    ...
    expected = {
        ...
        "run_root": "results/runs/__syncmate_small_selection_gu_full_v1__",
...
def _projected_config(stage: str, cfg: Mapping[str, Any]) -> Dict[str, Any]:
    ...
    return {
        "name": "syncmate_small_selection_gu_full_v1__{0}".format(stage),
        "dataset": dataset,
