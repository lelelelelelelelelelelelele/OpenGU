...
CONFIG_PATH = REPO_ROOT / "experiments" / "configs" / "syncmate_small_selection_gu_gate_v3.yaml"
EVIDENCE_ROOT = Path("/autodl-fs/data/OpenGU-small-selection-gu/20260722/gate-v3")
RUN_ROOT = REPO_ROOT / "results" / "runs" / "__syncmate_small_selection_gu_v3__"
...
def _config() -> Dict[str, Any]:
    ...
    expected = {
        ...
        "runtime_root": "/autodl-fs/data/OpenGU-small-selection-gu/20260722/gate-v3/runtime",
        "run_root": "results/runs/__syncmate_small_selection_gu_v3__",
    }
