...
CONFIG_PATH = REPO_ROOT / "experiments" / "configs" / "syncmate_small_selection_gu_gate_v1.yaml"
EVIDENCE_ROOT = Path("/autodl-fs/data/OpenGU-small-selection-gu/20260722/gate-v1")
RUN_ROOT = REPO_ROOT / "results" / "runs" / "__syncmate_small_selection_gu_v1__"
...
def _config() -> Dict[str, Any]:
    ...
    expected = {
        ...
        "runtime_root": "/autodl-fs/data/OpenGU-small-selection-gu/20260722/gate-v1/runtime",
        "run_root": "results/runs/__syncmate_small_selection_gu_v1__",
    }
