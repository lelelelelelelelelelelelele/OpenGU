...
CONFIG_PATH = REPO_ROOT / "experiments" / "configs" / "syncmate_small_selection_gu_gate_v2.yaml"
EVIDENCE_ROOT = Path("/autodl-fs/data/OpenGU-small-selection-gu/20260722/gate-v2")
RUN_ROOT = REPO_ROOT / "results" / "runs" / "__syncmate_small_selection_gu_v2__"
...
def _config() -> Dict[str, Any]:
    ...
    expected = {
        ...
        "runtime_root": "/autodl-fs/data/OpenGU-small-selection-gu/20260722/gate-v2/runtime",
        "run_root": "results/runs/__syncmate_small_selection_gu_v2__",
    }
