...
unlearning_path = root_path + "/data/unlearning_task/unlearning_nodes_" + str(args["proportion_unlearned_nodes"]) + "_" + args["dataset_name"] 
unlearning_edge_path = root_path + "/data/unlearning_task/unlearning_edges_" + str(args["proportion_unlearned_edges"]) + "_" + args["dataset_name"] 
BLUE_COLOR = "\033[34m"
RESET_COLOR = "\033[0m"