% NeurIPS 2026 Paper Checklist (REQUIRED, NOT COUNTED IN PAGE LIMIT)
...
\item {\bf Claims}
    ...
    \item[] Justification: The abstract summarizes the threat model, Vulnerability Fingerprint, and collateral diagnostics; the introduction (\S\ref{sec:intro}) maps these contributions to the paper sections.

\item {\bf Limitations}
    \item[] Question: Does the paper discuss the limitations of the work performed by the authors?
    \item[] Answer: \answerYes{}
    \item[] Justification: \S\ref{sec:limitations} enumerates seven limitations (L1--L7), including shard-count coverage, statistical-power trade-offs on ogbn-arxiv, TracIn scalability bounds, and scope boundaries such as claim-conditioned slicing and L2-direct vs.\ surrogate gaps.
...
\item {\bf Open access to data and code}
    ...
    \item[] Answer: \answerYes{}
    \item[] Justification: All datasets are public benchmarks (Cora, Citeseer, ogbn-arxiv). The full attack framework, configuration YAMLs, and reproduction scripts are included in the anonymous supplementary material. A public repository will be released upon acceptance.
...
\item {\bf New assets}
    ...
    \item[] Answer: \answerYes{}
    \item[] Justification: The attack framework is documented in the anonymous supplementary material (README, configuration YAMLs, per-strategy implementation notes, and reproduction scripts).
...
\item {\bf Declaration of LLM usage}
    ...
    \item[] Answer: \answerYes{}
    \item[] Justification: LLMs were used for writing assistance, grammatical editing, and LaTeX formatting only; they were not used as a core methodology component.
