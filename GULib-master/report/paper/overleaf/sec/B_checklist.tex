...
\item {\bf Limitations}
    ...
    \item[] Answer: \answerYes{}
    \item[] Justification: \S\ref{sec:limitations} discusses shard-count coverage, 3-seed arxiv power, TracIn scaling, L2-direct vs.\ surrogate scope, small-graph ratio sweeps, category coverage, and claim-conditioned slicing.
